package com.example.analistasistemas.pruebasqllte.sql;
...
public class DataBaseHelper extends SQLiteOpenHelper {
    ...
    public List<User> getAllUser() {
        ...
        if (cursor.moveToFirst()) {
            do {
                User user = new User();
                user.setId_number(Integer.parseInt(cursor.getString(cursor.getColumnIndex(COLUMN_USER_ID))));
    ...
    public void updateUser(User user) {
        ...
        db.update(TABLE_USER, values, COLUMN_USER_ID + " = ?",
                new String[]{String.valueOf(user.getId_number())});
        db.close();
    }
